...
public class HomeController {
    ...
    public HomeController(MoviesBean moviesBean, AlbumsBean albumsBean,
                          ...
                          @Qualifier("moviesTransactionOperations") TransactionOperations moviesTransaction, @Qualifier("albumsTransactionOperations") TransactionOperations albumsTransaction) {
